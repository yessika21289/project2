...
class Smpki extends CI_Controller {
	...
	public function kontak()
	{
        ...
        else
        {
			...
			redirect(base_url()."smpki/kontak");
        }
	}
	...
	public function kurikulum()
	{
		...
		$data['html_title'] = "Kurikulum - SMP Kristen Indonesia";
		$data['instansi'] = "smpki";
	...
	public function kesiswaan()
	{
		...
		$data['html_title'] = "Kesiswaan - SMP Kristen Indonesia";
		$data['instansi'] = "smpki";
	...
	public function program()
	{
		...
		$data['html_title'] = "Program Penerimaan Peserta Didik Baru - SMP Kristen Indonesia";
		$data['instansi'] = "smpki";
		...
		if(!empty($program)) {
			$program = $program[0];
			$data['program']['smpki'] = $program->aktif;
