...
<head>
	...
	<link rel="stylesheet" type="text/css" href="<?php echo base_url().'asset/css/ekko-lightbox.min.css'; ?>">
    ...
    <script type="text/javascript" src="<?php echo base_url().'asset/js/ekko-lightbox.min.js'; ?>"></script>
